function [f,g] = t30(Solucao_candidata)    
    ...
    areaSolucao_candidata(19)=Solucao_candidata(1,4);
    areaSolucao_candidata(20)=Solucao_candidata(1,4);
    areaSolucao_candidata(21)=Solucao_candidata(1,4);
    areaSolucao_candidata(22)=Solucao_candidata(1,4);
    areaSolucao_candidata(23)=Solucao_candidata(1,4);
    areaSolucao_candidata(24)=Solucao_candidata(1,4);
    ...
    index=find(areaSolucao_candidata~=0);  
...
%     f=funcpop(areaSolucao_candidata',ro,L,NumFO);
    ...
    g=restricao(abs(DeslVE(1:6)),QuantRestr);
